...
<section class="pb-[120px] relative pt-[60px] mt-[-50px]">
    <span class="blur-circle absolute top-[200px] left-0"></span>
    <span class="blur-circle absolute top-[200px] right-0 !h-[600px]"></span>
            ...
            <div class="w-[44%] relative">
                ...
                <ul class="mt-5 relative z-10">
                    <li class="mb-7 flex gap-[10px]">
                        <a href="#" class="text-[#0A4489] leading-6 text-[22px] font-[500]">High School Data Science</a>
                        <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/arrow-orange.svg">
                    </li>
                    <li class="mb-7 flex gap-[10px]">
                        <a href="#" class="text-[#0A4489] leading-6 text-[22px] font-[500]">Middle School Data
                            Science</a>
                        <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/arrow-orange.svg">
                    </li>
                    <li class="mb-7 flex gap-[10px]">
                        <a href="#" class="text-[#0A4489] leading-6 text-[22px] font-[500]">Professional Development
                            <br>
