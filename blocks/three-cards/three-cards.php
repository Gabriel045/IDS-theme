...
<section class="flex flex-col">
    <span class="blur-circle absolute bottom-[50px] left-0"></span>
    <div class="block_content">
        ...
        <div class="flex gap-7 py-16 flex-wrap lg:flex-nowrap relative">
            ...
            <div class="hero-img rounded-t-[30px] px-10 pt-[60px] pb-[40px] w-full <?php echo count($cards) == 3 ? 'lg:w-1/3' : 'w-full md:w-1/2' ?> bg-white flex flex-col justify-between gap-10 h-auto"
        ...
        <div class="flex items-center flex-col gap-7">
            <p class="!text-base text-GrayText text-center block max-w-[676px]"><?php echo $text ?></p>
            <?php if ($cta["url"]) : ?>
